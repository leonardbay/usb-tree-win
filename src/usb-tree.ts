...
function getDeviceName(vid: string, pid: string, rawName: string): string {
 ...
 */
export function buildUSBTree(): USBTree {
    const { devices, comPorts } = getUSBTreeData();
